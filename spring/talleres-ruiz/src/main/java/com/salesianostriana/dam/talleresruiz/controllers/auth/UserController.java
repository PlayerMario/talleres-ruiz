...
public class UserController {
    ...
    public UserDto changePsw(@Valid @RequestBody UserPassword userPassword, @AuthenticationPrincipal User user) {
        return UserDto.of(service.editPassword(user.getId(), userPassword));
    }
