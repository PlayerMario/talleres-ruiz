...
public class FileSystemStorageService implements StorageService {
    ...
    public void init() {
        ...
        try {
            ...
            throw new StorageException("No se pudo inicializar el almacén de ficheros", e);
        }
    ...
    public String store(MultipartFile file) {
        try {
            ...
            throw new StorageException("Error al guardar el fichero: " + file.getOriginalFilename(), ex);
        }
    }
    ...
    public Stream<Path> loadAll() {
        try {
            ...
            throw new StorageException("Error al leer todos los ficheros", e);
        }
    ...
    public Resource loadAsResource(String filename) {
        try {
            ...
            if (resource.exists() && resource.isReadable()) {
                ...
                throw new BuscarFicheroException("No se encuentra el fichero: " + filename);
            }

        } catch (MalformedURLException ex) {
            throw new StorageException("No se pudo leer el fichero: " + filename);
        }
    }
    ...
    public void deleteFile(String filename) {
        try {
            ...
            throw new StorageException("No se pudo borrar el fichero:" + filename);
        }
    }
    ...
    public void deleteAll() {
        try {
            ...
            throw new StorageException("No se pudieron borrar los ficheros");
        }
    }
